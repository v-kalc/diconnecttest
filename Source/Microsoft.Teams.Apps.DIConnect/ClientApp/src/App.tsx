...
import PauseMatches from './components/PauseMatches/pauseMatches';
          ...
          <div className="appContainer">
            <BrowserRouter>
              <Switch>
                ...
                <Route exact path="/registerGroup" component={RegisterGroup} />
                <Route exact path="/pauseMatches" component={PauseMatches} />
